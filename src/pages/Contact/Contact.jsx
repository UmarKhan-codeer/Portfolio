...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "c9e3aaaf-78a2-4c4e-b168-da4b708ff5d1");
    form.append("from_name", "Umar's Portfolio Contact Form");
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">umarjavedkhan22@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <a
                      href="https://www.linkedin.com/in/umerrjaved/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-400 hover:underline"
                    >
                      linkedin.com/in/umerrjaved/
                    </a>
                  </div>
                </div>
              </div>

...
const projects = [
  {
    title: "Scrapify – AI Web Scraper",
    description: "A smart web scraper using AI to summarize content and export structured data in JSON format.",
    src: "Scrapify.jpg",
  ...
  description: "A modern and responsive food ordering website built with React, Tailwind CSS, and Firebase for real-time menu updates and order management.",
  src: "grillout.jpg", 
...
},
 {
  ...
  description: "An AI-powered resume builder that helps users create professional resumes based on their input and job requirements, with PDF export functionality.",
...
},
{
  ...
  description: "A secure, elegant, and fully client-side password manager built with React and Web Crypto API. Features include AES-GCM encryption, strong password generator, strength meter, clipboard copy, and local vault editing.",
  src: "passop.jpg",
